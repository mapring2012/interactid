...
class IndexController extends Zend_Controller_Action {
	...
	public function registerAction() {
		...
		if ($this->getRequest ()->getPost ( 'btnSave' )) {
			...
			$BodyAccountActive= 'Click on this link to activate your account: <a href="'.$base.'/'.$lan.'/index/confirm?email='.$this->email.'&activated='.$getCodGeneration.'">Active Now!</a>';
			$sendemail=$sendemail->SendEmail($name,$email,$base,$lan,$header,$subjects,$activeAccount,$BodyAccountActive);
