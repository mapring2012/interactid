(function (c) {
	...
	c.extend(c.validator, {
		...
		messages : {
			...
			email : "S'il vous plait entrer une adresse email valide.",
			...
			equalTo : "S'il vous plait entrer la meme valeur a nouveau.",
			accept : "Please enter a value with a valid extension.",
			maxlength : c.validator.format("Please enter no more than {0} characters."),
			minlength : c.validator.format("S'il vous plait entrer au moins {0} caracteres."),
